...
const PostCard = ({ post }) => {
    ...
    return (
        <div className="bg-gradient shadow-lg rounded-lg p-0 lg:p-6 pb-12 mb-4">
            ...
            <h1 className="transition duration-100 flex text-center justify-center mb-4 h-20 cursor-pointer text-gray-800 hover:text-gray-600 text-xl font-semibold">
            ...
            <div className="block lg:flex text-center items-center justify-center mb-8 lg:mb-6 lg:justify-around w-full">
                <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
                    <p className="inline align-middle text-gray-600 ml-2 font-medium text-base">{post.author.name}</p>
                </div>
            ...
            <p className='text-center text-sm text-gray-600 font-light px-6 lg:px-0 overflow-hidden lg:h-24 mb-8'>{getExcerpt(post.excerpt)}</p>
